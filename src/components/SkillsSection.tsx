...
const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Ethical Hacking', level: 90, icon: Key },
      { name: 'Security Auditing', level: 82, icon: Eye },
    ],
  },
  {
    title: 'DevOps & Tools',
    ...
    skills: [
      ...
      { name: 'CI/CD', level: 78, icon: Workflow },
    ],
  },
  {
    title: 'Leadership',
    ...
    skills: [
      ...
      { name: 'Team Leadership', level: 90, icon: Cpu },
      { name: 'Agile/Scrum', level: 88, icon: Zap },
      { name: 'Mentoring', level: 85, icon: Binary },
    ],
  },
];
