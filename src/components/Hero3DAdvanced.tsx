  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ y: y1 }}
        animate={prefersReducedMotion ? {} : { opacity: [0.15, 0.3, 0.15] }}
        transition={{ duration: 6, repeat: Infinity }}
      />

      {/* Glowing orbs background */}
      <motion.div
        className="absolute top-1/4 left-1/4 w-[600px] h-[600px] bg-primary/15 rounded-full blur-3xl"
        style={{
      ...
      <motion.div
        className="absolute w-96 h-96 border border-primary/20 rounded-full hidden lg:block"
      ...
      <motion.div
        className="absolute w-64 h-64 border border-secondary/20 hidden lg:block"
      ...
      {/* SVG polygons */}
      <motion.svg
        className="absolute left-[10%] top-[30%] w-32 h-32 text-primary/30 hidden lg:block"
        viewBox="0 0 100 100"
        style={{ y: y1 }}
        animate={prefersReducedMotion ? {} : { rotate: 360 }}
      ...
      >
        ...
        >
          ...
          >
            Full-Stack Engineer passionate about building scalable applications with modern technologies and creating exceptional user experiences.
          </motion.p>
